...
<template>
    ...
    >   
        ...
        <div class="flex justify-between mt-2">
            <p :class="`${statusClass} rounded-lg px-2 py-1 font-semibold`"> {{ application.status }}</p>

            <button 
                @click="goToDetail"
                class="bg-emerald-500 font-semibold rounded-lg px-2 py-1 cursor-pointer hover:bg-emerald-600 transition"
